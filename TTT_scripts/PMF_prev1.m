function [logit_stats_right, logit_stats_left, logit_stats_rightall, logit_stats_leftall] = PMF_prev1(data,task)

% fits PMF separately for trials with t-1 rewarded to the right and t-1
% rewarded to the left for each session and for all data combined. Input is
% data structure
