function [mu, sd] = social_fitpsf_cdf_2conds(probitin, varargin)
%
% The function
%       [mu, sd] = social_fitpsf_cdf_2conds(probitin, varargin)
%
...
% - probit.expno = ID number of the experimental condition (social
% condition:)
%
% Expno == 0 : Leftwards social cue
% Expno == 1 : Rightwards social cue
%
% Using social_fitpsf_cdf_2conds(probit, 'expno', n) will fit only the data for which
% probit.expno = n.
%
%
...
if expno == 0
   ...
   orange = [1 0.5 0];
   errorbar(stim_set, probit.resps ./ probit.n, probit.sem,'o', 'Color', orange, 'MarkerFaceColor', orange,  'LineWidth', 1);
   hold on;
...
elseif expno == 1    
  ...
  errorbar(stim_set, probit.resps ./ probit.n, probit.sem, 'o', 'color', 'b', 'MarkerFaceColor', 'b',  'LineWidth', 1);
